...
if local == FR:
    st.write(
        ...
        <span style="font-size: 20px;"> Après plus de 10 ans à travailler en tant que Customer Success Manager dans des entreprises de SaaS spécialisées en Etudes de Marché et IA (Vision Critical, Alida, EasyPicky), j'ai décidé de me réorienter en Data Analyse. J'ai pour cela effectué le <a href="https://www.lewagon.com/fr/data-analytics-course" target="_blank">Bootcamp Data Analytics du Wagon </a> et je recherche actuellement un nouveau poste !</span>
        ...
        <span style="font-size: 20px;">Enfin, pour vous donner une idée de mes compétences, j'ai décidé de mettre en ligne mon CV et quelques projets de data analyse en ligne. <b>Vous pouvez accéder aux différentes pages sur l'onglet à gauche de la page.</b></span>
    ...
    st.markdown(
        ...
        <span style="font-size: 20px;"> After more than 10 years working as a Customer Success Manager in SaaS companies specialized in Market Research and AI (Vision Critical, Alida, EasyPicky), I decided to transition into Data Analytics. To achieve this, I completed the <a href="https://www.lewagon.com/data-analytics-course" target="_blank">Le Wagon Data Analytics Bootcamp</a>, and I am currently looking for a new opportunity!</span>
        ...
        <span style="font-size: 20px;">Finally, to give you an idea of my skills, I decided to put my resume and some data analysis projects online. You can access the different pages from the tab on the left side of the page.</span>
